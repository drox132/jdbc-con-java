...
public class ControlDeStockFrame extends JFrame {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                	Producto producto = new Producto(
                			Integer.parseInt(modelo.getValueAt(tabla.getSelectedRow(), 0).toString()),
                			(String) modelo.getValueAt(tabla.getSelectedRow(), 1),
                			(String) modelo.getValueAt(tabla.getSelectedRow(), 2),
                			Integer.parseInt( modelo.getValueAt(tabla.getSelectedRow(), 3).toString())
                			);
    ...
    private void guardar() {
        ...
        JOptionPane.showMessageDialog(this, "Producto Registrado con éxito! ID = " +pkProductoInsertado);
